                ...
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="<?php echo e(url('register')); ?>" id="infix_form">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-12">
									...
									<div class="input-effect mb-40 in_single_input">
                                        <select class="mb-26 niceSelect infix_theme_style w-100 bb form-control<?php echo e($errors->has('role_id') ? ' is-invalid' : ''); ?>" name="role_id" id="select-school">
