...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.system_settings'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.system_settings'); ?></a>
                <a href="<?php echo e(route('role')); ?>"><?php echo app('translator')->get('lang.role'); ?></a>
                <a href="<?php echo e(route('assign_permission', [$role->id])); ?>"><?php echo app('translator')->get('lang.assign_permission'); ?></a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('lang.assign_permission'); ?> (<?php echo e(@$role->name); ?>)</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 base-setup role-permission">
                            <table id="school-table-style" class="display school-table-style" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <?php endif; ?>
                                    <tr>
                                        <th><?php echo app('translator')->get('lang.module'); ?></th>
                                        <th><?php echo app('translator')->get('lang.module_link'); ?></th>
                                        <th><?php echo app('translator')->get('lang.permission'); ?></th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-lg-12 mt-20 text-right">
                                                    <?php if(Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > <?php echo app('translator')->get('lang.save'); ?></button></span>
                                                <?php else: ?>
