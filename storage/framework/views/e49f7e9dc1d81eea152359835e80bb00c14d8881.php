...
else{ $favicon = 'public/backEnd/img/favicon.png'; }
                ...
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="<?php echo e(url('/student-login')); ?>" id="infix_form">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/pylearni/Gurutecherp.com/resources/views/auth/studentLogin.blade.php ENDPATH**/ ?>