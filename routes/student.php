...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::get('student-profile',  'Student\SmStudentPanelController@studentProfile');

        Route::get('student-dashboard',  'Student\SmStudentPanelController@studentDashboard');
