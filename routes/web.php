...
/*Route::get('sendmail', function () {
    ...
    Mail::send('backEnd.studentInformation.user_credential', compact('data'), function ($message) {
     ...
     $Schoolname = 'fdgfdg';
     $message->to('dmmalik@ymail.com', $Schoolname)->subject('Login Credentials');
...
Route::get('register_school','RegisterSchoolController@index');
Route::post('register_school','RegisterSchoolController@create');
Route::get('/school/{school_Id}','auth\SchoolController@index');
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('register/{school_Id1}',[ 'as' => 'register', 'uses' => 'SmFrontendController@register']);	 
    ...
    Route::group(['middleware' => ['CheckUserMiddleware']], function () {
        ...
        Route::get('login',[ 'as' => 'login', 'uses' => 'Auth\LoginController@school_Login']);
...
//        Route::get('login-2', 'Auth\LoginController@loginFormTwo');
    ...
    Route::get('student-login', 'Auth\UserLoginController@index');
    Route::post('student-login', 'Auth\UserLoginController@stlogin');
